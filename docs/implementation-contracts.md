...
This file records planned implementation-level commitments. It is not AL code.
...
| Area | Planned Objects | Responsibility |
| --- | --- | --- |
...
- No AL code generation until readiness allows it.
